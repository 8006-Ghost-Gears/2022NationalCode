...
JoystickButton limelight = new JoystickButton(driver, 6);
  ...
  public RobotContainer() {
    ...
    camera.setResolution(480, 260); //Usually (640,320) // Will work at 160, 120
    camera.setFPS(30);
  ...
  private void configureButtonBindings() {
    shooter.whileTrue(new shooterCommand());
    intake.whileTrue(new intakeCommand());
intakeReverse.whileTrue(new outtakeCommand());
climber.whileTrue(new climberCommand());
climberDown.whileTrue(new climberDownCommand());
limelight.whileTrue(new limelightTurnCommand());
