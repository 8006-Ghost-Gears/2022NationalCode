...
public class driveSub extends SubsystemBase {
  ...
  public driveSub() {
    ...
    flDrive.setInverted(false); // use to be false
    blDrive.setInverted(false); // use to be false
    frDrive.setInverted(true); // use to be true
    brDrive.setInverted(true); // use to be true
